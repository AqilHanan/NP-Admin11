...
class _KAP_TimingState extends State<KAP_Timing> {
  ...
  Future<void> getKAP_MorningBus() async {
    try {
      ...
      KAP_Morning.clear();
      var data = await _makeRequest('GET', 'https://ihramr4p5b.execute-api.ap-southeast-2.amazonaws.com/prod/timing?info=KAP_MorningBus');
  ...
  Future<void> getKAP_AfternoonBus() async {
    try {
      ...
      KAP_Afternoon.clear();
      var data = await _makeRequest('GET', 'https://ihramr4p5b.execute-api.ap-southeast-2.amazonaws.com/prod/timing?info=KAP_AfternoonBus');
      print("Raw data from API: $data");
