...
class _BusStopState extends State<BusStop> {
  ...
  Future<void> getBusStops() async {
    try {
      ...
      var data = await _makeRequest(
          'GET',
          'https://ihramr4p5b.execute-api.ap-southeast-2.amazonaws.com/prod/busstop?info=BusStops'
      );
  ...
  Future<void> submitStop(String stop, String lat, String lng) async {
    final url = Uri.parse('https://ihramr4p5b.execute-api.ap-southeast-2.amazonaws.com/prod/busstop');
    final data = {
      'info': 'BusStops',
      'updateKey': 'positions',
      'id': stop,
  ...
  Future<void> deleteData(String info, String updateKey, String id) async {
    final url = Uri.parse('https://ihramr4p5b.execute-api.ap-southeast-2.amazonaws.com/prod/busstop'); // Replace with your actual API endpoint
